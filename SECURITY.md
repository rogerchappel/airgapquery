...
Replace this section with the supported versions for `airgapquery`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `airgapquery` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in airgapquery.
